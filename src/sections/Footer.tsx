...
const Footer: React.FC<FooterProps> = ({ darkMode, isEnglish }) => {
  ...
  return (
    <footer
      className={`w-full ${darkMode ? 'bg-gray-900 border-gray-800' : 'bg-gray-200 border-gray-100'} backdrop-blur-sm border-t py-10`}
      style={{ marginTop: '500px' }}
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className={`text-lg font-medium tracking-tight ${darkMode ? 'text-white' : 'text-black'}`}>Gabriel Lisboa</h3>
    ...
    : "Desenvolvendo sistemas backend robustos e escaláveis com foco em eficiência e confiabilidade."}  
        ...
        <div className="mt-12 pt-8 border-t border-gray-400">
          <div className="flex items-center justify-center space-x-2 text-sm text-gray-500">
            <Copyright className={`w-4 h-4 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`} />
